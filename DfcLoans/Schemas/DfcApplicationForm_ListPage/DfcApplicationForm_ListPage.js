define("DfcApplicationForm_ListPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
					...
					"columns": [
						{
							...
							"code": "PDS_Participant",
							"caption": "#ResourceString(PDS_Participant)#",
							"dataValueType": 1
						},
						{
			...
			},
			{
				...
				"name": "FolderTree",
				"values": {
					"sourceSchemaName": "AppFormFolder",
